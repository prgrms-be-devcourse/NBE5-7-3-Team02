...
class MemberService(
    ...
    fun updateProfile(
        ...
        val followerCount = followRepository.countByFollowing(member)
        val followingCount = followRepository.countByFollower(member)

        return member.toMemberUpdateResponse(followerCount, followingCount)
    }
