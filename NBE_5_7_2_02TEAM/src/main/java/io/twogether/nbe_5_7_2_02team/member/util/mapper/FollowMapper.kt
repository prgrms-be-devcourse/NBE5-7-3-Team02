...
fun Long.toFollowRequest(targetId: Long): FollowRequest =
    FollowRequest(followerId = this, followingId = targetId)

fun Follow.toFollowCreateResponse(
    followerCount: Long, followingCount: Long
): FollowCreateResponse = FollowCreateResponse(
